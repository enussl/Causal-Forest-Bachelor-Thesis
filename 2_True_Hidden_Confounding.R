...
setwd("C:\\Users\\eminu\\Desktop\\Bachelor Thesis Finish\\True Hiddden Confounding")
...
source(".\\1_True_Hidden_Confounding.R")

#Bringing Everything Together and Paralleization
run.hiddentrue = function(t, t.test, d, noise, entity, shift, rho, n.sim, seed) {
...
for (j in n){
  for(i in d){
    ...
    #Run
    result = run.hiddentrue(t = j, t.test = j, d = i, noise = 1, entity = 10, shift = "no", rho = 0.2, n.sim = 100, seed = 10)
    save.image(paste(".\\Results\\True_Hidden_Confounding",j,i,".RData", sep = ""))
  }
}
